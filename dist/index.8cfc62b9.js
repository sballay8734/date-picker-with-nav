...
datePickerButton.innerText = (0, _dateFns.format)(todaysDate, "MMMM do, yyyy");
datePickerButton.dataset.currentDate = (0, _dateFns.getUnixTime)(todaysDate);
datePickerHeaderText.innerText = (0, _dateFns.format)(todaysDate, "MMMM - yyyy");
// *****************************************************************************
...
function setUpDatePicker() {
    ...
    datePickerButton.dataset.currentDate = (0, _dateFns.getUnixTime)(globalCurrentDate);
    setUpDates(globalCurrentDate);
}
function setUpDates(dateFromButton) {
    datePickerHeaderText.innerText = (0, _dateFns.format)(dateFromButton, "MMMM - yyyy");
    const firstWeekStart = (0, _dateFns.startOfWeek)((0, _dateFns.startOfMonth)(dateFromButton));
    const lastWeekEnd = (0, _dateFns.endOfWeek)((0, _dateFns.endOfMonth)(dateFromButton));
    ...
    dates.forEach((date)=>{
        ...
        if (!(0, _dateFns.isSameMonth)(date, dateFromButton)) dateElement.classList.add("date-picker-other-month-date");
        dateElement.addEventListener("click", (e)=>{
            removeSelectedDate();
            globalCurrentDate = date;
            datePickerButton.innerText = (0, _dateFns.format)(globalCurrentDate, "MMMM do, yyyy");
        });
        if ((0, _dateFns.isSameDay)(date, globalCurrentDate)) dateElement.classList.add("selected");
...
document.addEventListener("click", (e)=>{
    ...
    if (e.target.matches(".prev-month-button")) {
        const currentDate = (0, _dateFns.fromUnixTime)(datePickerButton.dataset.currentDate);
        setUpDates((0, _dateFns.sub)(currentDate, {
            months: 1
        }));
        datePickerButton.dataset.currentDate = (0, _dateFns.getUnixTime)((0, _dateFns.sub)(currentDate, {
            months: 1
        }));
    }
    if (e.target.matches(".next-month-button")) {
        const currentDate = (0, _dateFns.fromUnixTime)(datePickerButton.dataset.currentDate);
        setUpDates((0, _dateFns.add)(currentDate, {
            months: 1
        }));
        datePickerButton.dataset.currentDate = (0, _dateFns.getUnixTime)((0, _dateFns.add)(currentDate, {
            months: 1
        }));
    }
});
...
},{"../_lib/toInteger/index.js":"f7kKX","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a6iyr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"zfeMe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/toInteger/index.js":"f7kKX","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1UhOp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../getTime/index.js":"1UhOp","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jEo6n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../startOfDay/index.js":"4Tvs3","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Tvs3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"43kxe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6xvSk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/toInteger/index.js":"f7kKX","../_lib/requiredArgs/index.js":"9wUgQ","../_lib/defaultOptions/index.js":"dWs8l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lF4Wf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire9bf3")
